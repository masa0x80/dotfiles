...
export FZF_DEFAULT_OPTS='--reverse --extended --ansi --multi --cycle --bind=ctrl-j:accept,ctrl-u:page-up,ctrl-d:page-down,alt-d:deselect-all,alt-a:toggle-all,ctrl-z:toggle-all'
