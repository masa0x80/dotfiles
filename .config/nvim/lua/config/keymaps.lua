...
map("n", "<C-t>1", "<Cmd>tabnext 1<CR>", { desc = "tabnext 1" })
map("n", "<C-t>2", "<Cmd>tabnext 2<CR>", { desc = "tabnext 2" })
map("n", "<C-t>3", "<Cmd>tabnext 3<CR>", { desc = "tabnext 3" })
map("n", "<C-t>4", "<Cmd>tabnext 4<CR>", { desc = "tabnext 4" })
map("n", "<C-t>5", "<Cmd>tabnext 5<CR>", { desc = "tabnext 5" })
map("n", "<C-t>6", "<Cmd>tabnext 6<CR>", { desc = "tabnext 6" })
map("n", "<C-t>7", "<Cmd>tabnext 7<CR>", { desc = "tabnext 7" })
...
-- marks
map("n", "<C-g><CR>", "`mzt10<C-y>", { desc = "`mzt10<C-y>" })
