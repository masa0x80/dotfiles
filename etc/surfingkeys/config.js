...
mapkey("]", "next page", clickElm("#btnNext"), { domain: slideShareDomain });
...
mapkey("]]", "next date", moveDate(1), { domain: bookmarkDomain });
mapkey("[[", "prev date", moveDate(-1), { domain: bookmarkDomain });

// youtube
const youtubeDomain = /youtube\.com/i;
mapkey("T", "Toggle theater mode", clickElm(".ytp-size-button.ytp-button"), {
